...
export default function InputTextIcon({estado,handle,placeholder,Icon,style,ocultar,value}:{estado:string,handle:(value:string) => void,placeholder:string,Icon:IconType,style?:React.CSSProperties,ocultar?:boolean,value?:string}){
